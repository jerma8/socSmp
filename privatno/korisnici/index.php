...
<div class="row relativePosition">		
	<div class="large-5 columns">
		...
		<div id="<?php echo $_SESSION['korisnik']->sifra; ?>" class="panel pricingPanel">
					...
					<ul class="pricing-table">
						...
						?>
							...
							<li id="podlogaNone" class="naziv"><?php echo $_SESSION['korisnik'] -> ime . " " . $_SESSION['korisnik'] -> prezime; ?></li>
	...
	<div class="large-7 relativePositionMeniKorisnici columns">	
		<div id="meniRadius" class="icon-bar five-up">
		  ...
		  <!--
		  <a href="<?php echo $putanjaApp; ?>privatno/korisnici/osobniPodaci.php" class="ikone item">
		    <img src="<?php echo $putanjaApp; ?>css/foundation-icons/svgs/fi-torsos-all.svg" >
		    <label>Osobni podaci</label>
		  </a>
		  
		  id="trecaIkonaKorisnici"
		  -->
		  <a href="namirnice.php" class="ikone item">
