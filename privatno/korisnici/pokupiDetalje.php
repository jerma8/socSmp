<?php
	...
	$izraz = $veza -> prepare("	select ime,prezime,oib,datumRodenja,adresa,mjesto,brojClanovaObitelji 
...
?>
	...
	<table>
		...
		<tr>
			<th>Datum rođenja:</th>
			<td><?php echo $detalji->datumRodenja; ?></td>
		</tr>
		...
		<tr>
			...
			<td><?php echo $detalji->brojClanovaObitelji; ?></td>
		</tr>
	</table>