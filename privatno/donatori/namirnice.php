...
if($_POST){
	...
	$izraz = $veza -> prepare("
	insert into pripremaDonacije(sifraKorisnika,sifraNamirnice,naziv,kolicina,jedinicaMjere,rokTrajanja,datumSlanjaPripreme) values
	(:sifra,:sifraNamirnice,:naziv,:kolicina,:jedinicaMjere,:rokTrajanja,:datumSlanjaPripreme)");
	
	$izraz->bindParam(":sifra",$_SESSION["donator"]->sifra);
	...
	if(isset($_POST['doniraj'])){
		foreach ($_POST['doniraj'] as $s) {
			...
			(sifraKorisnika,sifraNamirnice,naziv,kolicina,jedinicaMjere,datumSlanjaPripreme) 
			values
			...
			<div class="panel">
				<div class="row">
					<div class="large-10 columns">
						<h2 class="h25Font"><?php echo $_SESSION["donator"]->ime . " " . $_SESSION["donator"]->prezime; ?></h2>
					</div>
					<div class="large-2 columns">
						<a id="nazad" class="button round right" href="<?php echo $putanjaApp; ?>privatno/donatori/index.php">Nazad</a>
					</div>
				</div>
				<hr class="hrLinija"/>
				...
				<div class="panel panelBorder">
					<div id="#porukaDonacije" data-alert class="large-6 large-centered columns alert-box info radius columns">
						...
						<a href="#" class="close">&times;</a>
								...
								<form method="post" action="<?php echo $putanjaApp; ?>privatno/donatori/namirnice.php?active=2">		
									<?php
			...
			<div class="row">
				<div class="panel panelBorder">
					<div class="row">
						...
						<form method="post" action="<?php echo $putanjaApp; ?>privatno/donatori/namirnice.php?active=3">
							<div class="row">
								<div class="large-12 columns">
		...
		/* sakri button ako ništa nije označeno */
			...
			$(document).ready(function(){
				...
				$('#posaljiTrazeno').click(function(){
    				$('#uspjesnoDonirane').foundation('reveal','open');
    				//setTimeout($('#uspjesnoDonirane').dialog('close'), 10000);
					return true;
				});
				*/
