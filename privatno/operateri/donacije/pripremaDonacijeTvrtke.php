...
<html class="no-js" lang="en">
	...
	<body>
		...
		<?php
			...
			$izraz = $veza -> prepare("
			select
			a.sifra,a.naziv as nazivTvrtke,a.email,
						...
						<div class="large-12 columns">
							<div class="row">
								<div class="large-8 columns">
									<h2 class="h25Font">Priprema donacije tvrtke <?php echo $nazivTvrtke; ?></h2>
								</div>
								<div class="large-2 columns">
									<a id="nazad" class="button round right" href="<?php echo $putanjaApp; ?>privatno/operateri/donacije/index.php">Nazad</a>
								</div>
							</div>
						</div>
					</div>
