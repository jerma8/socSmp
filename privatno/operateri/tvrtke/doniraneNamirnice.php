...
if (isset($_GET['sifra'])) {
	$sifra = $_GET['sifra'];
} else if (isset($_POST['sifraTvrtke'])) {
	$sifra = $_POST['sifraTvrtke'];
}
...
if($_POST){
	...
	if(isset($_POST['hidSifraNamirnice']) && $_POST['hidSifraNamirnice']!=""){
		...
		$izraz = $veza -> prepare("
		delete from donira where sifraTvrtke=:sifraTvrtke and sifraNamirnice=:hidSifraNamirnice and datumIsporuke=:hidDatum
		");
		$izraz ->bindParam(":sifraTvrtke",$_POST['sifraTvrtke']);
		...
		$izraz = $veza -> prepare("
		delete from donira where sifraTvrtke=:sifraTvrtke
		");
		$izraz ->bindParam(":sifraTvrtke",$_POST['sifraTvrtke']);
		$izraz -> execute();
...
$izraz = $veza -> prepare("
select naziv from tvrtka where sifra=:sifra
");
						...
						<div class="panel">
								...
								<div class="large-12 columns">
									<div class="row">
										<div class="large-9 columns">
											<h2 class="h25Font">Namirnice tvrtke</h2>
											<h2 class="h25Font"><?php echo $tvrtka->naziv; ?></h2>
										</div>
							...
							<div class="panel panelBorder">
								...
								<tr>
									...
									<!--
									<td colspan="2">
										<a title="Pošalji mail" class="obrisiNamirnicu iconsColor" href="#"><i class="fi-mail"></i>&nbsp;&nbsp; Pošalji mail namirnica</a>
									</td>
									-->
