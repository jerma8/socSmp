<div id="myModal2" class="reveal-modal tiny" data-reveal data-animation="fade" 
	...
	<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
		...
		<div class="row collapse">
				<div class="large-6 columns">
					<input style="width: 100%;" id="<?php echo $sifra; ?>" class="obrisi button" type="submit" value="DA" />
				</div>
				<div class="large-6 columns">
