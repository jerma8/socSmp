...
$pdf->SetTitle('Namirnice donatora ' . $objekt->ime . " " . $objekt->prezime);
$pdf->SetSubject('Podaci o namirnicama ');
$pdf->SetKeywords('Namirnice');

// set default header data
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, "Izvještaj namirnica donatora ", $objekt->ime." ".$objekt->prezime, array(0,64,255), array(0,64,128));
...
// This method has several options, check the source code documentation for more information.
$pdf->Output('Namirnice_donatora_' . substr($objekt->prezime,0,1) . "." . $objekt->ime . '.pdf', 'I');
